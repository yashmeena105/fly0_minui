...
// components
import {
  FormProvider, RHFEditor, RHFRadioGroup, RHFSelect, RHFSwitch, RHFTextField, RHFUploadMultiFile
...
export default function ProductNewEditForm({ isEdit, currentProduct }) {
  ...
  console.log("fdjhdghf", values?.description);
  return (
        ...
        <Grid item xs={12} md={8}>
          <Card sx={{ p: 3 }}>
            <Stack spacing={3}>
              ...
              <div>
                <LabelStyle>Descriptionsd</LabelStyle>
